...
public class KDTree<V> {
	 ...
	 */
	public KDTree(int kdTreeDim, KDTreeResolver<V> treeResolver, ObjectOrdering objectOrdering,
	...
	public KDTree(int kdTreeDim, KDTreeResolver<V> treeResolver, Collection<? extends V> elements) {
